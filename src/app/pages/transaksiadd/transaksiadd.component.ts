...
export class TransaksiaddComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.http.get(this.config.apiBaseUrl+"api/JadwalLelang/" + this.idjadwal, this.api.generateHeader()).subscribe((result: any) => {
    ...
    if (this.isEditMode || this.isPreview) {
      ...
      this.http.get(this.config.apiBaseUrl+"api/TransaksiLelang/" + idperiode, this.api.generateHeader()).subscribe((result: any) => {
