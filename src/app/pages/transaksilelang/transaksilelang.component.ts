...
@Component({
  selector: 'app-transaksilelang',
  templateUrl: './transaksilelang.component.html',
})
export class TransaksiLelangComponent {
  ...
  clickDetail(tahun: number) {
    this.router.navigateByUrl(`/transaksilist?tahun=${tahun}`)
  }
