...
export class JadwaladdComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        if (this.isEditMode || this.isPreview) {
            ...
            this.http.get(this.config.apiBaseUrl+"api/JadwalLelang/" + idperiode, this.api.generateHeader()).subscribe((result: any) => {
            ...
            this.http.get(this.config.apiBaseUrl+"api/PeriodePelaporan/"+idperiode, this.api.generateHeader()).subscribe((result: any) => {
