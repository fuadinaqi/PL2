...
export class DropdownMenuComponent implements OnInit, AfterViewInit {
  ...
  constructor(private dropdownMenuElement: ElementRef, private renderer: Renderer2) {}
  ...
  fixStyles(): any {
    if (this.dropdownMenuElement) {
      ...
      const offsetLeft = this.dropdownMenuElement.nativeElement.getBoundingClientRect().left
